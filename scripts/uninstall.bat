@echo off
rem scripts\uninstall.bat
rem Runs the OctoSuite uninstaller. Data is kept unless -DeleteData is given (asks for confirmation).
rem
...
rem Extra arguments are passed through, e.g.:  uninstall.bat -Yes
...
"%OCTO_PS%" -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%~dp0lib\octo.ps1" uninstall %*
