@echo off
rem scripts\backup-profile.bat
rem Creates a zip backup (+ .sha256) of one OctoBrowser profile. Options: -Profile <name|id> -Destination <folder>.
rem
...
rem Extra arguments are passed through, e.g.:  backup-profile.bat -Yes
...
"%OCTO_PS%" -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%~dp0lib\octo.ps1" backup-profile %*
