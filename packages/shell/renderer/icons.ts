...
const P: Record<string, string> = {
  windows: 'M3 5.5l7.5-1v7H3zM12 4.3L21 3v8.5h-9zM3 12.5h7.5v7L3 18.5zM12 12.5h9V21l-9-1.3z',
  apple: 'M16.5 12.6c0-2.2 1.8-3.2 1.9-3.3-1-1.5-2.6-1.7-3.2-1.7-1.3-.1-2.6.8-3.3.8s-1.7-.8-2.9-.8C7.5 7.6 6 8.5 5.2 9.9c-1.6 2.8-.4 7 1.2 9.2.8 1.1 1.7 2.3 2.8 2.3s1.6-.7 2.9-.7 1.7.7 2.9.7 2-1.1 2.7-2.2c.9-1.3 1.2-2.5 1.2-2.6-.1 0-2.4-.9-2.4-3.9zM14.4 5.9c.6-.7 1-1.8.9-2.9-.9 0-2 .6-2.6 1.3-.6.6-1.1 1.7-.9 2.8 1 .1 2-.5 2.6-1.2z',
  linux: 'M12 3c-2 0-3 1.7-3 4 0 1.5-.5 2.5-1.5 4S5 14.5 5 16.5c0 1 .5 1.8 1.5 2.2L9 20h6l2.5-1.3c1-.4 1.5-1.2 1.5-2.2 0-2-1.5-4-2.5-5.5S15 8.5 15 7c0-2.3-1-4-3-4zM10.5 7.5h.01M13.5 7.5h.01M10.5 10l1.5 1 1.5-1',
  dots: 'M12 5.5h.01M12 12h.01M12 18.5h.01',
  swap: 'M4 8h13l-3-3M20 16H7l3 3',
  api: 'M8 8l-4 4 4 4M16 8l4 4-4 4M13.5 5l-3 14',
  tag: 'M3 12V4h8l10 10-8 8zM7.5 7.5h.01',
  clock: 'M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18zM12 7v5l3 2',
  shuffle: 'M4 7h3c4 0 6 10 10 10h3M4 17h3c1.5 0 2.7-1.4 3.7-3M14 10c1-1.7 2-3 3-3h3M18 4l2 3-2 3M18 14l2 3-2 3',
  chevronsLeft: 'M11 6l-6 6 6 6M19 6l-6 6 6 6',
  chevronDown: 'M6 9l6 6 6-6',
  rocket: 'M5 15c-1.5 1.5-2 5-2 5s3.5-.5 5-2M9 11l4 4M14.5 4.5C18 3 21 3 21 3s0 3-1.5 6.5L13 16l-5-5z',
  folderPlus: 'M3 6h6l2 2h10v11H3zM12 11v5M9.5 13.5h5',
  proxy: 'M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18zM3 12h18M8 5l8 14',
  back: 'M15 5l-7 7 7 7',
